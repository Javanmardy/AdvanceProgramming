    ...
    def add_menu(self, menu):
        try:
            if not isinstance(menu, Menu):
                raise TypeError(Fore.RED + "Invalid menu object provided.")
            self.menu = menu
    ...
    def add_item(self, item):
        try:
            if not isinstance(item, MenuItem):
                raise TypeError(Fore.RED + "Invalid item object provided.")
    ...
    def remove_item(self, item_name):
        try:
            if not isinstance(item_name, str):
                raise TypeError(Fore.RED + "Invalid item name provided.")
    ...
    def place_order(self, restaurant, items):
        try:
            if not isinstance(restaurant, Restaurant):
                raise TypeError(Fore.RED + "Invalid restaurant object provided.")
            if not isinstance(items, list) or not all(
                isinstance(item, MenuItem) for item in items
            ):
                raise TypeError(Fore.RED + "Invalid items provided.")
    ...
    while True:
        ...
        if choice == 1:
            if selected_restaurant is None:
                contact_info = input(Fore.YELLOW + "Enter the contact information: ")
                ...
                if matching_restaurants:
                    ...
                    print(Fore.GREEN + "New restaurant account created and logged in.")
            ...
            if customer is None:
                contact_info = input(Fore.YELLOW + "Enter your contact information: ")
            ...
            while True:
                ...
                if option == 1:
                    ...
                    if not matching_restaurants:
                        print(
                            Fore.YELLOW + "No restaurants found with the same address."
                        )
                        continue
                    ...
                    while True:
                        ...
                        if option == 1:
                            ...
                            if menu:
                                ...
                                print(Fore.RED + "No menu found for the restaurant.")
                            ...
                            if order:
                                ...
                                print(Fore.GREEN + f"Customer Name: {customer.name}")
